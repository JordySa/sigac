...
{
    public partial class EquipoMantenimiento : System.Web.UI.Page
    {
                ...
                if (Request.QueryString["op"] != null)
                {
                    ...
                    switch (sOpc)
                    {
                        case "C":
                            ...
                            break;
                        case "R":
                            this.Lbltitulo.Text = "Vista del Equipo";
                            break;
                        case "U":
        ...
        private void CargarDatos()
        {
            ...
            string queryString = "SELECT * FROM GC_EQUIP WHERE strCod_Equip= '" + sID + "'";
        ...
        protected void BtnCreate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string insert = "INSERT INTO dbo.GC_EQUIP VALUES (@Id, @Nombre, '', GETDATE(), 0, '', '', 0, '', '', GETDATE(), '', '', '', '', '', 0, 0.00 )";
                ...
                string script = @"<script>
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = 'Equipos.aspx';
                        }
                    });
                </script>";
        ...
        protected void BtnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string update = @"
            UPDATE dbo.GC_EQUIP
            SET strNombre_Equip = @Nombre
            WHERE strCod_Equip = @Id";
        ...
        {
            string delete = $"DELETE FROM dbo.GC_EQUIP WHERE strCod_Equip = '{this.tbid.Text}'";
            cn.Open();
