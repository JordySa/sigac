<%@ Page Title="Padres" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Padres.aspx.cs" Inherits="sigac.view.ViewsGestionUsuarios.ViewsPadres.Padres" %>
        ...
        <div class="contenido" style="background-color: #EBEDEF;">
            <div class="main">
                <div class="container" style="width:100%; background-color: #fff; padding:12px; ">
                    <h2 class="mb-4">GESTION DE PADRES</h2>
                    <div class="vertical-space">                        
                        ...
                        <asp:GridView ID="GridViewPadre" runat="server" CssClass="table table-striped table-bordered descarga" AutoGenerateColumns="false">
                            <Columns>
