...
{
    public partial class PadreMantenimiento : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["op"] != null)
                {
                    ...
                    {
                        case "C":
                            this.Lbltitulo.Text = "Ingresar nuevo Padre";
                            this.BtnCreate.Visible = true;
                            // Generar un nuevo UUID para la creación
                            this.tbid.Text = Guid.NewGuid().ToString();
                            break;
                        case "R":
                            this.Lbltitulo.Text = "Vista del Padre";
                            break;
                        case "U":
                            this.Lbltitulo.Text = "Actualizar Padre";
                            ...
                            break;
                        case "D":
                            this.Lbltitulo.Text = "Eliminar Padre";
                            this.tbid.ReadOnly = true;
        ...
        {
            PadreViewModel padre = null;
            cn.Open();
            // Corregir la sintaxis de la consulta
            string queryString = "SELECT * FROM GC_PADRE WHERE strCod_padre= '" + sID + "'";
            ...
            if (padre != null)
            {
                this.tbid.Text = padre.Id;
                this.tbnombre.Text = padre.Nombre;
                this.tbdenominacion.Text = padre.Denominacion;
            }
        }
        ...
        protected void BtnCreate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string insert = "INSERT INTO dbo.GC_PADRE VALUES (@Id, @Nombre, @Denominacion, '', '', '', '', '', GETDATE(), '', '', '', '', '', 0, 0.00 )";
                ...
                using (SqlCommand command = new SqlCommand(insert, cn))
                {
                    ...
                    command.Parameters.AddWithValue("@Denominacion", this.tbdenominacion.Text.ToString()); ;
                ...
                string script = @"<script>
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = 'Padres.aspx';
                        }
                    });
                </script>";
        ...
        protected void BtnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string update = @"
            UPDATE dbo.GC_PADRE
            SET strNombre_padre = @Nombre, strDenominacion_padre = @Denominacion
            WHERE strCod_padre = @Id";
        ...
        {
            string delete = $"DELETE FROM dbo.GC_PADRE WHERE strCod_padre= '{this.tbid.Text}'";
            cn.Open();
