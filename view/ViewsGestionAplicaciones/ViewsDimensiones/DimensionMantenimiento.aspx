<%@ Page Title="DimensionMantenimiento" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DimensionMantenimiento.aspx.cs" Inherits="sigac.view.ViewsGestionAplicaciones.ViewsDimensiones.DimensionMantenimiento" %>
...
<asp:Button runat="server" class="btn btn-primary btn-dark" ID="BtnReturn" Text="Volver" Visible="true" OnClientClick="return redirectToPage();" />
    ...
    <asp:SqlDataSource ID="SqlDataSourceDimenciones" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnectionString %>" SelectCommand="SELECT strCod_func, strNombre_func FROM GC_FUNC"></asp:SqlDataSource>
