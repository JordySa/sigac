<%@ Page Title="EvidenciaMantenimiento" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EvidenciaMantenimiento.aspx.cs" Inherits="sigac.view.ViewsGestionAplicaciones.ViewsEvidencias.EvidenciaMantenimiento" %>
...
<asp:Button runat="server" class="btn btn-primary btn-dark" ID="BtnReturn" Text="Volver" Visible="true" OnClientClick="return redirectToPage();" />
    ...
    <asp:SqlDataSource ID="SqlDataSourceEvidencias" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnectionString %>" SelectCommand="SELECT strCod_fni, strNombre_fni FROM GC_FNI"></asp:SqlDataSource>
