<%@ Page Title="Periodicidades" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Periodicidades.aspx.cs" Inherits="sigac.view.ViewsGestionAplicaciones.ViewsPeriodicidades.Periodicidades" %>
            ...
            <div class="main">
                <div class="container" style="width:100%; background-color: #fff; padding:12px; ">
                    ...
                    <div class="vertical-space">                        
                        ...
                        <asp:GridView ID="GridViewPeriodicidad" runat="server" CssClass="table table-striped table-bordered descarga" AutoGenerateColumns="false">
                            <Columns>
