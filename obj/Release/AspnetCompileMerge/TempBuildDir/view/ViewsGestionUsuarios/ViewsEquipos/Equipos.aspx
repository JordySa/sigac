<%@ Page Title="Equipos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Equipos.aspx.cs" Inherits="sigac.view.ViewsGestionUsuarios.ViewsEquipos.Equipos" %>
        ...
        <div class="contenido " style="background-color: #EBEDEF;">
            <div class="main">
                ...
                <div class="container"  style="width:100%; background-color: #fff; padding:12px; ">
                    ...
                    <h2 class="mb-4">GESTIÓN DE EQUIPO</h2>
                    <div class="vertical-space">                        
                        ...
                        <asp:GridView ID="GridViewEquipo" runat="server" CssClass="table table-striped table-bordered descarga" AutoGenerateColumns="false">
                            <Columns>
